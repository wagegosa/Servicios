...
<body>
  <div class="container">
    ...
    <!-- Formulario -->
    <form method="post" autocomplete="on" id="frm" action="../../config/Vehiculo/ClassVehiculo_Ins.php">
      <!-- Placa -->
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
          <input type="text" class="form-control" name="Placa" rows="5" id="Placa" minlength="1" maxlength="6" placeholder="Placa">
